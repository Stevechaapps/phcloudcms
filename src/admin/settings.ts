...
<div class="form-group"><label for="heroKicker">Hero Kicker <span class="hint">(small label above site name; leave empty to hide)</span></label><input type="text" id="heroKicker" placeholder="e.g. Edge-published on Cloudflare" /></div>
...
document.getElementById('siteName').value=s.site_name||'';
  ...
  document.getElementById('heroKicker').value=s.hero_kicker||'';
...
var data={site_name:document.getElementById('siteName').value,seo_description:document.getElementById('seoDescription').value,hero_kicker:document.getElementById('heroKicker').value,ai_guidelines:document.getElementById('aiGuidelines').value,mcp_token:document.getElementById('mcpToken').value};
