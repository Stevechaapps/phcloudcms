...
<div class="form-group"><label for="excerpt">Excerpt <span style="color:var(--ad-muted);font-weight:400">(optional, max 255 chars)</span></label><textarea id="excerpt" name="excerpt" rows="1" maxlength="255"></textarea></div>
...
<div class="form-group"><label for="excerpt">Excerpt <span style="color:var(--ad-muted);font-weight:400">(optional, max 255 chars)</span></label><textarea id="excerpt" name="excerpt" rows="1" maxlength="255">${esc(String(post.excerpt ?? ""))}</textarea></div>
 <div class="form-group">
  <label for="content">Content <span style="color:var(--ad-muted);font-weight:400">(Rich text)</span></label>
  <div class="toolbar">
    <button type="button" onmousedown="event.preventDefault();rteHead('<p>')" title="Paragraph" aria-label="Paragraph">¶</button><button type="button" onmousedown="event.preventDefault();rteCmd('bold')" title="Bold" aria-label="Bold"><strong>B</strong></button>
